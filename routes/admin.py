...
import database_init  # REMOVED: from app import DAO
...
book_manager = BookManager(database_init.db_instance)
user_manager = UserManager(database_init.db_instance)
admin_manager = AdminManager(database_init.db_instance)
