...
# We will initialize this inside a before_app_request so it has access to the app context safely
# user_manager = None
user_manager = UserManager(database_init.db_instance)

@user_view.before_request
def init_user_manager():
    global user_manager
    if user_manager is None:
        from app import DAO  # Safe to import here because the app is fully built now!
        user_manager = UserManager(DAO)

# Now, keep all your route code exactly as it originally was below this line...
